...
import com.savvycom.userservice.exception.*;
...
public class ControllerExceptionHandler extends BaseController {
    ...
    public ResponseEntity<?> handleException(UserAlreadyExistException e) {
        return failedResponse(HttpStatus.UNPROCESSABLE_ENTITY.value() + "", e.getMessage());
    }
    ...
    public ResponseEntity<?> handleException(EntityNotFoundException e) {
        return failedResponse(HttpStatus.NOT_FOUND.value() + "", e.getMessage());
    }
